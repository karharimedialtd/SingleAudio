...
export function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await login(formData.email, formData.password, formData.twoFactorCode)
  ...
  {/* Logo - Now using Single Audio logo */}
  <div className="flex items-center space-x-2">
    ...
    <span className="font-semibold text-blue-600">Single Audio</span>
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-500">Enter your credentials to view all insights</p>
      </div>
